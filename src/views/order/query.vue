    ...
    <el-form :label-position="labelPosition2" label-width="auto" :model="filters" style="max-width: 100%">
        ...
        <el-col :span="8" class="el-col">
          <div class="grid-content ep-bg-purple">
            <el-form-item label="供应商:">
              <el-input v-model="filters.ccode" placeholder="请输入供应商" />
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8" class="el-col">
          <div class="grid-content ep-bg-purple-light">
            <el-form-item label="订单号:">
              <el-input v-model="filters.cinvcode" placeholder="请输入订单号" />
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="8" class="el-col">
          <div class="grid-content ep-bg-purple">
            <el-form-item label="存货编码:">
              <el-input v-model="filters.cinvname" placeholder="请输入存货编码" />
            </el-form-item>
        ...
        <el-col :span="8" class="el-col">
          <div class="grid-content ep-bg-purple">
            <el-form-item label="存货名称:">
              ...
              <el-input v-model="filters.ddate" placeholder="请输入存货名称" />
        ...
        <el-col :span="8" class="el-col">
          <div class="grid-content ep-bg-purple">
            <el-form-item label="订单状态:">
              <el-select v-model="filters.dindan" placeholder="选择状态" :loading="ElSelectLoading" style="width: 100%"
                name="caccid">
      ...
      <el-row class="el-row">
        <el-col :span="24" class="el-col">
          ...
          <el-button @click="loadData" type="info "> <span>重置</span></el-button>
          <el-button @click="loadData" type="danger"> <span>打印</span></el-button>
...
export default {
  ...
  data() {
    return {
      ...
      filters: { guanbi: '', dindan: '', ccode: '', cordercode: '', cinvstd: '', ddate: ref(''), cvencode: '', cinvcode: '', cinvname: '', dpodate: ref(''), zhuangtai: '', cvenabbname: '' },
      pageNum_List: 1,
      pageSize_List: 10,
      total_List: 0,
      ...
      zhuangtaiList: [{ value: '1', label: '已确认' }, { value: '0', label: '未确认' }, { value: '2', label: '全部' }],
      dindanList: [{ value: '1', label: '已完成' }, { value: '0', label: '未完成' }, { value: '2', label: '全部' }],
      guanbiList: [{ value: '1', label: '已关闭' }, { value: '0', label: '未关闭' }, { value: '2', label: '全部' }],
      VouchID: '',
      SysInfo:
      {
        cUserId: 'demo',
